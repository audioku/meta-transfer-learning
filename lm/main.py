...
corpus = data.Corpus(args.train_path, args.valid_path, args.test_path, None, args.seed)
...
# new_train_data = batchify(corpus.new_train, args.batch_size)
train_data = batchify(corpus.train, args.batch_size)
# cs_data = batchify(corpus.cs, args.batch_size)
val_data = batchify(corpus.valid, eval_batch_size)
test_data = batchify(corpus.test, eval_batch_size)

# mono_en_data = batchify(corpus.mono_en, args.batch_size)
# mono_zh_data = batchify(corpus.mono_zh, args.batch_size)
